...
- [ ] **[ALTA PRIORIDAD]** Configurar tarea programada en Windows (Programador de Tareas)
      para `ejecutar_diario.ps1` a las **21:00 hs** todos los días.
      Comando para registrarla (ejecutar como Administrador en PowerShell):
      ```powershell
