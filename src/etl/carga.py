...
class Carga:
    ...
    def a_bd(
        ...
        logger.info("Cargados %d registros en %s.%s", n, schema or "public", tabla)
        return n
    ...
    def a_csv(self, df: pd.DataFrame, nombre_archivo: str) -> Path:
        """Guarda el DataFrame como CSV en el directorio de datos configurado."""
    ...
    def a_excel(
        ...
        """Guarda el DataFrame como Excel en el directorio de datos configurado."""
        ruta = self.config.directorio_datos / nombre_archivo
    ...
    def registrar_rechazos(
        ...
        if df_invalidos.empty:
            logger.info("Sin registros rechazados. No se genera archivo de auditoría.")
            return None
